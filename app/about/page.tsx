...
const AnimatedStat = ({ label, value, suffix = "" }: { label: string; value: number; suffix?: string }) => {
    ...
    return (
        <div ref={ref} className="text-center p-6 rounded-2xl bg-white border-2 border-[#1e1b4b] shadow-[4px_4px_0px_0px_#4ACF50]">
            <div className="text-4xl md:text-5xl font-black text-[#4ACF50] mb-2 font-mono drop-shadow-sm text-shadow-sm">
                {count}{suffix}
            </div>
            <div className="text-[#1e1b4b] font-bold uppercase tracking-widest text-sm">
                {label}
            </div>
        </div>
    );
...
const ValueCard = ({ icon: Icon, title, description, delay }: { icon: any, title: string, description: string, delay: number }) => {
    return (
        <motion.div
            ...
            whileHover={{ y: -10 }}
            className="p-8 rounded-3xl border-2 border-[#1e1b4b] bg-white shadow-[8px_8px_0px_0px_#1e1b4b] hover:shadow-[4px_4px_0px_0px_#1e1b4b] transition-all group"
        >
            <div className="bg-[#4ACF50] p-4 rounded-2xl w-fit mb-6 text-[#1e1b4b] border-2 border-[#1e1b4b] shadow-[4px_4px_0px_0px_#1e1b4b] group-hover:scale-110 transition-transform duration-300">
                <Icon size={32} />
            </div>
            <h3 className="text-xl font-black text-[#1e1b4b] mb-3 group-hover:text-[#E91E63] transition-colors gap-2 flex items-center">{title}</h3>
            <p className="text-[#1e1b4b]/80 leading-relaxed font-bold">
                {description}
            </p>
        </motion.div>
    );
...
export default function AboutPage() {
    ...
    return (
        <div ref={containerRef} className="bg-white min-h-screen relative overflow-hidden">
            ...
            <div className="absolute top-[50%] left-[-100px] w-[500px] h-[500px] bg-[#E91E63]/10 rounded-full blur-[100px]" />
            <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#FF9800]/10 rounded-full blur-[100px]" />
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    >
                        <span className="inline-block py-2 px-6 rounded-full bg-[#FF9800] text-[#1e1b4b] border-[3px] border-white shadow-lg text-sm font-black tracking-[0.2em] uppercase mb-6 transform -rotate-2">
                            Since 1998
                        </span>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        className="text-xl text-[#1e1b4b]/70 max-w-2xl mx-auto font-bold"
                    >
            ...
            <section className="py-24 md:py-32 relative">
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <h2 className="text-[#E91E63] font-black tracking-widest uppercase mb-4 text-sm">Our Story</h2>
                            <h3 className="text-4xl md:text-6xl font-black text-[#1e1b4b] mb-8 leading-none">
                                From Humble Beginnings to <span className="text-[#4ACF50] italic">Masters of Taste</span>
                            </h3>
                            <div className="space-y-6 text-[#1e1b4b]/70 text-lg leading-relaxed font-medium">
                                <p>
                                    It started with a simple passion: to bring the authentic, rich flavors of Delhi's streets to gala events. What began in a small kitchen has grown into <strong className="text-[#1e1b4b]">Delhi Delight Caterers</strong>, a name synonymous with luxury banquet execution.
                                </p>
                                <p>
                        ...
                        >
                            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-[12px_12px_0px_0px_#1e1b4b] border-[4px] border-[#1e1b4b] group bg-white">
                                ...
                                <div className="absolute bottom-0 left-0 p-8 z-20">
                                    ...
                                    <p className="text-[#4ACF50] mt-2 font-bold uppercase text-sm tracking-widest">— Head Chef</p>
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <motion.h2
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="text-3xl md:text-5xl font-black text-[#1e1b4b] mb-4"
                        >
                            Our Core <span className="text-[#4ACF50]">Values</span>
                        </motion.h2>
                        <motion.p
                            ...
                            className="text-[#1e1b4b]/60 max-w-2xl mx-auto font-bold"
                        >
            ...
            <section className="py-32 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-green-600 opacity-10" />
                <div className="container mx-auto px-6 text-center relative z-10">
                    <motion.div
                        ...
                        className="bg-[#E91E63] border-[4px] border-[#1e1b4b] p-12 md:p-20 rounded-[3rem] shadow-[12px_12px_0px_0px_#4ACF50] relative overflow-hidden group"
                    >
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white blur-[100px] opacity-20 group-hover:opacity-30 transition-opacity" />
